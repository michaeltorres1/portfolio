...
const Timeline = ({ isDarkMode }) => {
  ...
  let backgroundColor = isDarkMode ? '#1d1e2d' : '#fff';
  ...
  return (
    <VerticalTimeline>
      <VerticalTimelineElement
        ...
        date='2020 - present'
        iconStyle={{ background: '#06304e', color: textColor }}
      >
        ...
        <p className='font-weight-lighter'>
          ...
          MongoDB, ExpressJS, React, and NodeJS. AWS (Amazon Web Services) is
          used to save content that client uploads
        </p>
      </VerticalTimelineElement>
      <VerticalTimelineElement
        ...
        <div className='d-flex flex-column justify-content-center'>
          ...
          <div>
            <p className='text-center font-weight-lighter'>
              ...
              Ruby on Rails, PostgreSQL, React / Redux, HTML5 and CSS3. Movies
              and images are stored using AWS
            </p>
          </div>
        </div>
      </VerticalTimelineElement>
        ...
        <div className='d-flex flex-column justify-content-center'>
          ...
          <div>
            <p className='text-center font-weight-lighter'>
              ...
              searched through the search bar and that article along with
              similar articles will come back as results along with the
              reliabilty of that article.
            </p>
          </div>
        </div>
      </VerticalTimelineElement>
      ...
      >
        ...
        <p className='font-weight-lighter'>
          A 3 month intensive Full-Stack web development coding bootcamp with
          less than 3% acceptance rate. Focusing on Ruby on Rails, JavaScript,
          React, PostgreSQL and MongoDB
        </p>
      </VerticalTimelineElement>
      <VerticalTimelineElement
        className='vertical-timeline-element--education'
      ...
      >
        ...
        <p className='font-weight-lighter'>
          ...
          passion is in Computer Science and started my career learning Python
          and Java
        </p>
      </VerticalTimelineElement>
      <VerticalTimelineElement
